...
The spec deals with two questions:
...
such that IF all the path-namespace mappings are valid PSR-X mappings, THEN
- Whenever a fully qualified class name $C is being requested for autoloading,
